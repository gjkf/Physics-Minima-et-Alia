...
Per scoprire la direzione del nuovo vettore si può usare la così detta 'regola della mano`. Essa dice:
\begin{enumerate}
	...
	\item Il nuovo vettore avrà la direzione che attraversa il palmo perpendicolarmente e il verso 
	uscente dalla mano.
\end{enumerate}