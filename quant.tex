...
\begin{center}
  \begin{tikzpicture}
    ...
    \draw (1,2) -- ++(210:2.4) -- ++(110:1.2) -- ++(20:1) -- ++(-70:1.2) -- ++(210:0.8) 
...
\begin{center}
  \begin{tikzpicture}
    \begin{axis}[xmin=0,ymin=0,xmax=8,ymax=8,xlabel=$\lambda$,ylabel=$I$]
...
\begin{center}
  \begin{tikzpicture}[every pin edge/.style={black,thin}, pin distance=7mm]
    \begin{axis}[xmin=-2,ymin=0,xmax=8,ymax=5,clip mode=individual,xlabel=$f$,ylabel=$i$]
  ...
  \end{tikzpicture}
\end{center}
\unsure[inline]{Controllare assi}
...
\begin{center}
  \begin{tikzpicture}[%
    ...
    \draw[wave,->,thin] (2.3,0) -- ++(45:1) 
      node[pos=1,above right] {$\lambda'$};
    \draw[wave,->,thin] (2.3,0) -- ++(-30:1)
      node[pos=1,right] {$e^-$};
