...
\subsubsection{Campo elettrico generato da una sfera}
\begin{center}
  \begin{tikzpicture}[scale=0.2]
    \draw [black,thick] (0,0)  circle (5) ;
    \fill[ball color=white!] (0,0) circle (5); 
    \draw[red,dashed] (0.01,-0.01)--(5,3.63);
    \draw [red,thick,->](5,3.63)--(6,4.35);
    \node at (5,3.61){.};
    \draw[blue,dashed] (0,0)--(-1.4,-2.44);
    \draw [blue,thick,->](-1.4,-2.5)--(-1.9,-3.39);
    \node at (-1.39,-2.5){.};
    \draw [dashed](0,0)--(5,0);
    \node at (2.6,-0.4) {R};
  \end{tikzpicture}
