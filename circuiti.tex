...
\end{equation*}
Se osserviamo il disegno però, essendo questi dei vettori, possiamo semplicemente fare la somma
...
\end{align*}
Osserviamo anche che la forma della corrente ricorda molto la legge di Ohm. Infatti viene definita
\textbf{impedenza}
\begin{equation*}
...
\end{equation*}
Ora possiamo un'ultima cosa: quale deve essere la frequenza del generatore perché la reattanza 
capacitiva e quella induttiva si equivalgano? In altri termini, come possiamo semplificare
il circuito in modo che abbia, di fatto, solo la resistenza? Viene così definita \textbf{condizione
di risonanza} se la frequenza è pari a
\begin{equation*}
