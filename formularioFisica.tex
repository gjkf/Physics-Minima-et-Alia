...
\subsection{Quantità di moto e teorema dell'impulso}
...
La gravitazione si occupa di studiare le forze che intercorrono tra corpi celesti come soli e 
pianeti.\\ 
Essendo le orbite ellittiche, $a$ e $b$ si riferiscono ai semiassi rispettivamente maggiore e 
minore.\\
...
\hyperref[tab:g]{$G$}: $6.67\cdot10^{-11}\,\text{Nm}^2\text{/kg}^2$\\
$M$: massa del pianeta\\
$R$: $r + h$: raggio del pianeta più quota
...
\section{Idrostatica}
L'idrostatica studia le situazioni di equilibrio di fluidi. Studia anche le pressioni.
...
Nelle seguenti formule, $S$ è definito come $\mathcolor{cyan}{A}\cdot\mathcolor{blue}{l}$.
...
\end{equation*}
\hyperref[tab:g]{$g$}: $9.81\,\text{m/s}^2$\\
$\mathcolor{red}{h}$: livello del fluido
...
Dimostrare il primo punto è estremamente semplice e richied solo nozioni di trigonometria. Il
...
\begin{equation*}
L = F\cdot S\cdot \cos\alpha \rightarrow L = 500\cdot0\cdot20\cdot\cos90 = 
\boxed{0\,\text{N}\cdot\text{m}}
\end{equation*}
Per trovare la potenza abbiamo bisogno anche del tempo. Troviamolo
\begin{equation*}
x = x_0 _vt \rightarrow 20 = 0+2t \rightarrow t = 10\,\text{s}
\end{equation*}
...
{\centering  ``\textit{Il raggio vettore che parte dal Sole e 
arriva al pianeta, spazza aree uguali in tempi uguali}''.}\\
