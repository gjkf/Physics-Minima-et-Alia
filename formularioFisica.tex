...
\usepackage{tikz}
\usetikzlibrary{arrows,decorations,calc,intersections,shapes.geometric,shapes.misc}
...
\fancyfoot[L,LO]{Version 1.0.3 \today
}
...
\begin{center}
	\begin{xtabular}{c M{1.8cm} c M{1.5cm}}
		...
		\label{tab:mT}
		$m_{\text{Terra}}$ & Massa della Terra & $5.9\cdot10^{24}$ & $kg$\\ \hline
		\label{tab:rT}
		$r_{\text{Terra}}$ & Raggio della Terra & $6378$ & $m$\\ \hline 
		\label{tab:patm} 
		...
		\label{tab:c} 
		$c$ & Velocità della luce & $3\cdot10^8$ & $\frac{\text{m}}{\text{s}}$\\\hline
		\label{tab:I0} 
		$I_0$ & Soglia di udibilità & $10\cdot10^{-12}$ & 
		$\frac{\text{W}}{\text{m}^2}$\\ \hline
		\label{tab:Im} 
		$I_m$ & Soglia del dolore & $1$ & $\frac{\text{W}}{\text{m}^2}$\\ \hline
		\label{tab:vs} 
		$v$ & Velocità del suono & $343$ & $\frac{\text{m}}{\text{s}}$\\ \hline
		\label{tab:e0} 
		...
		\label{tab:e-} 
		$e^{-}$ & Carica di un elettrone & $-1.60\cdot10^{-19}$ & $\text{C}$\\ \hline
		\label{tab:me-} 
		$m_{e^{-}}$ & Massa di un elettrone & $9.11\cdot10^{-28}$ & $\text{kg}$\\\hline
		\label{tab:u} 
		$u$ & Unità di massa atomica & $1.7\cdot10^{-7}$ & $\text{kg}$\\\hline
		\label{tab:mu0} 
...
\begin{center}
	\begin{xtabular}{ M{1.8cm}  M{1.8cm}  c  c }
		...
		Campo Magnetico & Tesla & T & N(A$\cdot$m)$^{-1}$ \\ \hline
                Flusso & Weber & Wb & T$\cdot$m$^2$\\ \hline
	\end{xtabular}
\end{center}
