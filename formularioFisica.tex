\documentclass[8pt, a4paper, twocolumn, twoside,usenames]{extarticle}
...
\usepackage[showframe=false,top=1cm,bottom=1.5cm,left=1.5cm,right=1.5cm,marginparsep=0pt]{geometry}

\usepackage[pdftex,
pdfauthor={Davide Cossu, Stefano D'Agaro},
pdftitle={Formulario di Fisica},
pdfsubject={Fisica},
pdfkeywords={fisica, formulario, formule},
...
\input{gravitazione}
\input{fluidostatica}
\input{fluidodinamica}
\input{termodinamica}
\input{onde}
\input{elettrostatica}
\input{circuiti}
\input{magnetismo}
\input{elettromagnetismo}
\input{rel}
\input{quant}
\include{ex}
\include{appendix}
